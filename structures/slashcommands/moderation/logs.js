...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if(!config.developers.includes(interaction.user.id) && !interaction.member?.permissions.has(PermissionsBitField.resolve("Administrator"))) return interaction.reply({content: `You are missing permissions to perform this command.`, ephemeral: true})
